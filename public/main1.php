        ...
        <div id="peli" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                foreach ($peliculas as $pelis) {
                    ...
                    echo "<img src='{$pelis->getPoster()}' class='card-img-top' alt=''poster peli'>";
                    echo   "<div class='card-body'>";
                    echo   "<h5 class='card-title'><b>{$pelis->getTitulo()}</b></h5>";
                    echo "<p class='card-text'>{$pelis->getResumen()}</p>";
                    echo "<p class='card-text'><b>Fecha estreno: </b>{$pelis->getFechaEstreno()}</p>";
                    echo "</div>";
                    echo " </div>";
